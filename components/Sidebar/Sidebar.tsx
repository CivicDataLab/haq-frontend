	...
	return (
		<SidebarComp>
			...
			<div className="not-sidebar">
				...
				blep. I rule on my back you rub my tummy i bite you hard rub whiskers on
				bare skin act innocent lasers are tiny mice swat turds around the house
				being gorgeous with belly side up jump on fridge. Sit on human they not
				getting up ever break lamps and curl up into a ball meow and walk away
				always hungry so hit you unexpectedly, but bleghbleghvomit my furball
				really tie the room together. Meow flop over ask for petting.
			</div>
		</SidebarComp>
	)
}
