  ...
  return (
    <PartnersCard>
      <div className="partners__header">
        ...
        />
        <section>
          {card.link && card.link.website ? (
            <a href={card.link.website}>
              <h4>{card.name}</h4>
            </a>
          ) : (
            <h4>{card.name}</h4>
                ...
                <a href={card.link.twitter}>
                  ...
                  >
                    ...
                    <g clipPath="url(#clip0)">
                      <path
                        d="M18.1764 12.7031L29.3445 0H26.6978L17.0009 11.0297L9.25558 0H0.322266L12.0345 16.6791L0.322266 30H2.96901L13.2097 18.3523L21.389 30H30.3223L18.1757 12.7031H18.1764ZM14.5515 16.8258L13.3646 15.165L3.92256 1.94953H7.98778L15.6073 12.615L16.7939 14.2758L26.699 28.1391H22.6342L14.5515 16.8265V16.8258Z"
                        fill="#6C666E"
                      />
                    </g>
                    <defs>
      ...
      {card.link && card.link.email && (
        <a className="partners__footer" href={`mailto:${card.link.email}`}>
          {card.link.email}
        </a>
      )}
    </PartnersCard>
